...
<div class="form-rows-custom mt-3">
	...
	<?php if($enquiryRow['company'] != "") { ?>
		<div class="row mb-3">
			<div class="col-sm-3">
				<label for="company">Company</label>
			</div>
			<div class="col-sm-9">
				<input type="text" name="company" id="company" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($enquiryRow['company']); ?>" />
			</div>
		</div>
	<?php } ?>
