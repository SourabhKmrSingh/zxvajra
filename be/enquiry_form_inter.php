...
$fields = array('company'=>$company, 'first_name'=>$first_name, 'last_name'=>$last_name, 'email'=>$email, 'mobile'=>$mobile, 'subject'=>$subject, 'message'=>$message, 'remarks'=>$remarks, 'status'=>$status, 'user_ip'=>$user_ip);
