...
$fields = array('title'=>$title, 'title_id'=>$title_id, 'order_custom'=>$order_custom, 'imgName'=>$imgName, 'fileName'=>$fileName, 'priority'=>$priority, 'status'=>$status, 'user_ip'=>$user_ip);
