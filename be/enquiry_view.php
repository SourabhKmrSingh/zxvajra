...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header">Enquiries <?php if($_SESSION['per_write'] == "1") { ?><a href="enquiry_form.php?mode=insert" class="btn btn-default btn-sm button">Add New</a><?php } ?></h1>
	</div>
</div>
...
<table class="table table-striped table-view" cellspacing="0" width="100%">
	...
	if($data['num_rows'] >= 1)
	{
		...
		<tr class="text-center has-row-actions">
			...
			<td data-label="Name - ">
				<a href="enquiry_form.php?mode=edit&enquiryid=<?php echo $validation->db_field_validate($enquiryRow['enquiryid']); ?>" class="fw-500"><?php echo $validation->db_field_validate($enquiryRow['first_name'].' '.$enquiryRow['last_name']); ?></a>
			...
			<td data-label="Company - "><?php echo $validation->db_field_validate($enquiryRow['company']); ?></td>
