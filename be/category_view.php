...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header">Categories <?php if($_SESSION['per_write'] == "1") { ?><a href="category_form.php?mode=insert" class="btn btn-default btn-sm button">Add New</a><?php } ?></h1>
	</div>
</div>
...
<div class="row">
	<div class="col-sm-12 mb-0">
		<div class="form-inline">
			...
			<a href="category_view.php" class="btn btn-default mb_inline btn-sm btn_delete ml-sm-2 ml-md-0 mb-2">Clear</a>
		</div>
	</div>
</div>
					...
					<div class="col-sm-12">
						...
						<?php if($_SESSION['per_delete'] == "1") { ?>
							<a href="category_actions.php?q=del&categoryid=<?php echo $validation->db_field_validate($categoryRow['categoryid']); ?>" onClick="return del();" class="delete">Delete</a>
							 | 
						<?php } ?>
						<a href="subcategory_view.php?categoryid=<?php echo $validation->db_field_validate($categoryRow['categoryid']); ?>">Sub-Categories</a>
						 | 
