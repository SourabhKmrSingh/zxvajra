...
$sale = $validation->input_validate($_POST['sale']);
if($sale=='')
{
	$sale = 0;
}
...
$fields = array('title'=>$title, 'title_id'=>$title_id, 'tagline'=>$tagline, 'order_custom'=>$order_custom, 'sale'=>$sale, 'url'=>$url, 'url_target'=>$url_target, 'description'=>$description, 'imgName'=>$imgName, 'priority'=>$priority, 'status'=>$status, 'user_ip'=>$user_ip);
