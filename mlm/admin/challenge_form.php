...
<div class="form-rows-custom mt-3">
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<input type="number" name="time_period" id="time_period" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($challengeRow['time_period']); ?>" required />
