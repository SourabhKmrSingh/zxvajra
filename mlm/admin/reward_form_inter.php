...
$fields = array('planid'=>$planid, 'title'=>$title, 'title_id'=>$title_id, 'members'=>$members, 'earnings'=>$earnings, 'amount'=>$amount, 'order_custom'=>$order_custom, 'description'=>$description, 'imgName'=>$imgName, 'fileName'=>$fileName, 'priority'=>$priority, 'status'=>$status, 'user_ip'=>$user_ip);
