...
<div class="form-rows-custom mt-3">
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<select NAME="type" CLASS="form-control" ID="type" required >
				...
				<option value="user" <?php if($mode == 'edit') { if($userRow['type'] == "user") echo "selected"; } ?>>Sub-Admin</option>
			</select>
		</div>
	</div>
	...
	<div class="row mb-4">
		<div class="col-sm-3">
			<label for="per_ewallet">E-Wallet Permission</label>
		</div>
		<div class="col-sm-9">
			<input type="checkbox" name="per_ewallet" id="per_ewallet" <?php if($mode == 'edit') { if($userRow['per_ewallet'] == "1") echo "checked"; } ?> />
		</div>
	</div>
