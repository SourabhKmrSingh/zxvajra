...
$checkQueryResult = $db->view('userid', 'mlm_users', 'userid', "and password='$password' and userid='$userid'");
if($checkQueryResult['num_rows'] >= 1)
{
	if($_POST['new_password'] != "")
	{
		...
		$passwordQueryResult = $db->update("mlm_users", array('password'=>$new_password, 'modifytime'=>$createtime, 'modifydate'=>$createdate), array('userid'=>$userid));
