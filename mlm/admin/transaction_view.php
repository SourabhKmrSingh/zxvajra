...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header">Transactions <!--<?php if($_SESSION['per_write'] == "1") { ?><a href="transaction_form.php?mode=insert" class="btn btn-default btn-sm button">Add New</a><?php } ?>--></h1>
	</div>
</div>
...
<div class="row">
	<div class="col-sm-12 mb-0">
		<div class="form-inline">
			...
			<a href="transaction_view.php" class="btn btn-default mb_inline btn-sm btn_delete ml-sm-2 ml-md-0 mb-2">Clear</a>
		</div>
	</div>
</div>
