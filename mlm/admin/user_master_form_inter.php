...
$fields = array('type'=>$type, 'username'=>$username, 'password'=>$password, 'display_name'=>$display_name, 'email'=>$email, 'imgName'=>$imgName, 'per_read'=>$per_read, 'per_write'=>$per_write, 'per_update'=>$per_update, 'per_delete'=>$per_delete, 'per_ewallet'=>$per_ewallet, 'status'=>$status, 'user_ip'=>$user_ip);
