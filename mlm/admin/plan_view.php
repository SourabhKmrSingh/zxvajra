...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header">Plans <?php if($_SESSION['per_write'] == "1") { ?><a href="plan_form.php?mode=insert" class="btn btn-default btn-sm button">Add New</a><?php } ?></h1>
	</div>
</div>
...
<div class="row">
	<div class="col-sm-12 mb-0">
		<div class="form-inline">
			...
			<a href="plan_view.php" class="btn btn-default mb_inline btn-sm btn_delete ml-sm-2 ml-md-0 mb-2">Clear</a>
		</div>
	</div>
</div>
...
<table class="table table-striped table-view" cellspacing="0" width="100%">
	...
	<tr>
		...
		<th>Author</th>
		<th>Amount</th>
		<th class="<?php echo $th_sort2." ".$th_order_cls2; ?>"><a href="plan_view.php?orderby=order_custom&order=<?php echo $th_order2; echo $url_parameters; ?>"><span>Order</span> <span class="sorting-indicator"></span></a></th>
		<th>Title ID</th>
		<th>Status</th>
	...
	if($data['num_rows'] >= 1)
	{
		...
		<tr class="text-center has-row-actions">
			...
			<td data-label="Order - "><?php echo $validation->db_field_validate($planRow['order_custom']); ?></td>
			<td data-label="Title ID - "><?php echo $validation->db_field_validate($planRow['title_id']); ?></td>
