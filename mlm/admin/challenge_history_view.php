...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header">Challenges History <!--<?php if($_SESSION['per_write'] == "1") { ?><a href="challenge_history_form.php?mode=insert" class="btn btn-default btn-sm button">Add New</a><?php } ?>--></h1>
	</div>
</div>
