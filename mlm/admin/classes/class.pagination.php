...
class pagination
{
	...
	public function main($table, $url_parameters, $where_query, $id, $orderby)
	{
		global $connect;
		$db = new db;
		...
		$total_pages_row = $db->view($this->id, $this->table, $this->id, $this->where_query, $this->orderby);
		...
		$pageQueryResult = $db->view("*", $this->table, $this->id, $this->where_query, $this->orderby, "{$this->start}, {$this->limit}");
